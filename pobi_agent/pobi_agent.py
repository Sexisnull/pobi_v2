...
class DeadEndAgent:
    ...
    def __init__(
        ...
        if workspace_root is not None:
            ...
            # No explicit workspace_root was supplied (the common case when the
            # agent is instantiated through the Web Console, which does not send
            # one). Mount the default project workspace under the same agent
...
################################################################################
    ...
    def set_workspace_root(self, workspace_root: str | None) -> None:
        ...
        # up-front so callers (e.g. the Web Console, which never sends a
